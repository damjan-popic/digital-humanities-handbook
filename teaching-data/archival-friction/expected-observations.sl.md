...
- `correction-log.csv` vsebuje osem na viru utemeljenih uredniških odločitev
  in štiri razveljavitve sintetičnih motenj. Vse imajo lokator, dokaz,
  odgovorni postopek, datum, različico pravil, stopnjo zaupanja in podatek o
  povratnosti.
- Pregled OCR zajema celotni prijavljeni odlomek. Vrstice pregleda besednih
