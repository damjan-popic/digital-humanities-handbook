...
To poglavje obravnava varovala znotraj projekta. Poglavje [Kritične infrastrukture: moč, dostop in vzdrževanje](critical-infrastructures.md) pa širše obravnava zbirke, standarde, vmesnike, delo in vzdrževanje, ki projekt pogojujejo pred začetkom dela.
