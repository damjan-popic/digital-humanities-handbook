# Postopki analize besedil

Ti postopki pojmovna poglavja pretvorijo v majhne in pregledne izvedbe. Najprej jih preizkusite na vzorcu ter ohranite kodirni priročnik, parametre, različico vhoda in ročne preglede.

- [Raziskovanje ponavljajočih se tem z NMF](explore-topics-with-nmf.md)
- [Preverjanje stabilnosti in interpretabilnosti tematskega modela](test-topic-model-stability-and-interpretability.md)
