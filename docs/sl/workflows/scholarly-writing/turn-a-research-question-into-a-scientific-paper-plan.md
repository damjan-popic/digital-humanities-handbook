---
title: "Kako raziskovalno vprašanje pretvorim v načrt znanstvenega besedila?"
description: "Humanistični argument načrtujte iz vprašanja, dokaznega gradiva, protiprimera in omejitve, povzetek pa napišite šele po ustalitvi argumenta."
category: "Znanstveno pisanje"
category_id: "scholarly-writing"
difficulty: "začetno"
time: "75–120 min"
tags: [znanstveno-pisanje, argument, dokazno-gradivo, odstavek, načrtovanje]
---

# Kako raziskovalno vprašanje pretvorim v načrt znanstvenega besedila?

<div class="answer-meta" markdown>
<span>Znanstveno pisanje</span><span>začetno</span><span>75–120 min</span>
</div>
...
11. **Izvleček napišite na koncu.** Ko je argument stabilen, v kratkem izvlečku poimenujte problem, gradivo ali korpus, pristop, glavno trditev oziroma ugotovitev ter najpomembnejšo posledico ali omejitev. Ne obljubite dokazov ali sklepov, ki jih besedilo ne vsebuje več.
...
- Ali bo razumen bralec razumel pomen vprašanja in se lahko ne strinja s trditvijo?
- Ali vsak vir podpira dodeljeno rabo in ne le obravnava iste teme?
- Ali dokazno gradivo ločite od svoje interpretacije?
- Ali protiprimer spremeni, zoži ali preizkusi trditev?
- Ali izvleček opisuje dokončani argument in ne začetne namere?

## Pogoste pasti

- Temo, raziskovalno vprašanje in tezo uporabljate kot sopomenke.
- Razdelke uporabljate kot posode in ne kot argumentativne korake.
- Vstavite navedek in pričakujete, da se bo razložil sam.
- Parafrazirate z zamenjavo besed, skladnjo vira pa ohranite.
- Vsako humanistično besedilo prisilite v IMRaD ali pet odstavkov.
- Izvleček napišete zgodaj in ga ne uskladite z dokončanim besedilom.

## Viri in žanrska meja

Vire smo preverili **2. septembra 2026**: Harvard College Writing Center o [tezi](https://writingcenter.fas.harvard.edu/thesis), [organizaciji eseja](https://writingcenter.fas.harvard.edu/tips-organizing-your-essay), [odstavku](https://writingcenter.fas.harvard.edu/anatomy-body-paragraph) in [protiargumentu](https://writingcenter.fas.harvard.edu/counterargument); Purdue OWL o [navajanju, parafraziranju in povzemanju](https://owl.purdue.edu/owl/research_and_citation/using_research/quoting_paraphrasing_and_summarizing/index.html) ter izogibanju pretesni parafrazi; in Eric Hayot, *[The Elements of Academic Style: Writing for the Humanities](https://cup.columbia.edu/book/the-elements-of-academic-style/9780231537414/)* (Columbia University Press, 2014). Načrt prilagodite izrecnim pravilom svoje discipline in naloge.

## Naloga

Iz vzorčnih zapiskov izdelajte dva različna orisa razdelkov za isto vprašanje. Enega izberite, pojasnite poudarek drugega in znani problematični odstavek revidirajte tako, da bodo vidni raba vira, sklepanje in omejitev.
